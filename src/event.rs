...
// Mirrors the two message shapes documented in coinbase_feed.h's doc
#[derive(Debug, Deserialize)]
#[serde(tag = "channel")]
pub enum ChannelMessage {
    #[serde(rename = "l2_data")]
    L2Data {
        // sequence_num is captured but not yet read directly,
        // flagged for future gap detection
        #[allow(dead_code)]
        sequence_num: u64,
        #[allow(dead_code)]
        timestamp: String,
...
pub struct PriceLevelUpdate {
    ...
    pub price_level: String,  // string on the wire -- convert to fixed-point
...
mod tests {
    ...
    fn rejects_message_with_no_matching_channel() {
        let json =
            r#"{"channel": "heartbeats", "sequence_num": 0, "timestamp": "x", "events": []}"#;
